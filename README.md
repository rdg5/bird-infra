...
This project automates the deployment and management of BirdApp, showcasing essential DevOps practices with a focus on simplicity and automation. While production-grade deployments often utilize advanced cloud services like AWS EKS or a full Kubernetes cluster, this project intentionally uses basic components—an EC2 instance with Docker and k3s—to demonstrate how powerful DevOps principles can be, even without the most optimized or managed tools.

The decision to use this setup highlights the fundamentals of infrastructure automation, configuration management, and container orchestration, offering a clear understanding of how these practices work in a simpler, more cost-effective environment. By prioritizing simplicity, this project showcases that even smaller-scale infrastructure can be effectively managed using modern DevOps techniques, making it accessible for learning and experimentation without the overhead of more complex managed services.
